...
1. Update `table_motor_control/config/motor_ids.yaml` with the serial numbers for your specific TIC boards and update motor settings.
...
### Tic Serial Numbers and Settings:
...
Then you will want to determine the appropriate settings, namely the motor direction, max velocity, max acceleration, and current limit. The easiest way to do this is using the ticgui. Use [this](https://www.youtube.com/watch?v=-cAjdT6QN_w) quickstart video walkthrough for how to set the values. Then
...
## Resources
- [Tic User Manual](https://www.pololu.com/docs/0J71)
- [OpenCV Documentation](https://www.docs.opencv.org/master/)
- [ROS Image Pipeline](http://wiki.ros.org/image_pipeline)
- [oCam Manual](http://withrobot.com/en/camera/ocam-1cgn-u-t/)
